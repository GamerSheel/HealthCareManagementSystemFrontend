...
const ViewPreviousAppointmentsAdmin = () => {
    ...
    const viewDoctorDetails = async () => {
        try {
            const token = localStorage.getItem('token');
                ...
                const responseAllAppointments = await axios.get('http://localhost:8080/appointment/allPreviousAppointments', {
                    headers: {
...
export default ViewPreviousAppointmentsAdmin;
