...
const ViewUpcomingAppointmentsDoctor = () => {
    ...
    const viewDoctorDetails = async () => {
        try {
            ...
            const response = await axios.get('http://localhost:8080/currentLoginUser', {
                ...
                const responseAllAppointments = await axios.get('http://localhost:8080/appointment/UpcomingDoctorId', {
                    params: {
...
export default ViewUpcomingAppointmentsDoctor;
