...
const CreateNewAppointment = () => {
  ...
  return (
    <DashboardLayout>
        <Typography variant="h5" style={{ marginBottom:'8px', textAlign: 'center', color: 'primary.main' , fontWeight: 'bold'}}>
  Select a Doctor for Creating New Appointment
</Typography>
      ...
      <Grid container spacing={2} minWidth={'100px'}>
        {filteredAllDoctors.map((doctor, index) => (
          ...
          <Grid item xs={12} sm={6} md={6} key={index} >
             <Button onClick={() => appointmentBooking(doctor)}>
            <Card style={styles.card}>
              ...
              {/* <Button variant="outlined" color="primary" style={{ marginBottom: '10px' }}>See Schedule</Button> */}
              <Button variant="contained" color="primary" onClick={() => appointmentBooking(doctor)}>Book an appointment</Button>
              {/* </div> */}
            </Card>
            </Button>
          </Grid>
