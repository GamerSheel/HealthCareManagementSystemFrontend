...
const DoctorDegreeForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8080/speciality/saveDoctorSpeciality', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                setMessage('Doctor Speciality Form submitted successfully');
                setOpen(true);
                setTimeout(() => {
                    navigate('/doctorSpecialityForm', { message: "Doctor Degree Data submitted successfully" });
