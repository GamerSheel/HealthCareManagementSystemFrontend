...
const ViewPreviousAppointmentsDoctor = () => {
    ...
    const viewDoctorDetails = async () => {
        try {
            ...
            const response = await axios.get('http://localhost:8080/currentLoginUser', {
                ...
                const responseAllAppointments = await axios.get('http://localhost:8080/appointment/PreviousDoctorId', {
                    params: {
...
export default ViewPreviousAppointmentsDoctor;
